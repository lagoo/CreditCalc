...
{
    public class FisicalCreditTests
    {
        private FisicalCredit _sut;
        ...
        {
            _sut = new FisicalCredit(value, qtdInstallments, firstDueDate);
        ...
        {
            _sut = new FisicalCredit(100, 5, DateTime.Now.AddDays(15).Date);

            _sut.TotalValue.ShouldBe(103);
        }
