...
{
    public class RealStateCreditTests
    {
        private RealStateCredit _sut;
        ...
        {
            _sut = new RealStateCredit(value, qtdInstallments, firstDueDate);
        ...
        {
            _sut = new RealStateCredit(100, 5, DateTime.Now.AddDays(15).Date);

            _sut.TotalValue.ShouldBe(109);
        }
